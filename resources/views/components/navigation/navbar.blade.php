    ...
    <ul class="flex items-center justify-between">
        ...
        @elseif (!Route::is('index'))
            @if (Route::is('profil.index'))
                <li class="w-full">
                    <h1 class="capitalize font-medium">{{ __('Halaman Profil') }}</h1>
                </li>
            @elseif(Route::is('notifikasi.index'))
                <li class="w-full">
                    <h1 class="capitalize font-medium">{{ __('Halaman Notifikasi') }}</h1>
                </li>
            @else
                <li class="w-full">
                    ...
                    @if (!Route::is('index'))
                        ...
                        @else
                            @if (Auth::user()->role != 'peminjam')
                                <a class="whitespace-nowrap text-base font-medium transition-all bg-(--third-color) text-(--primary-color) hover:bg-(--third-color)/90 px-4 py-2 rounded-full"
