...
<head>
    ...
    <style>
        * {
        ...
        .header {
            text-align: center;
            border-bottom: 3px solid #24a148;
            padding-bottom: 15px;
            margin-bottom: 25px;
        }
...
<body>
    ...
    <h3 style="color: #24a148; margin-bottom: 10px;">Data Peminjam</h3>
    <table class="info-table">
        <tr>
    ...
    <h3 style="color: #24a148; margin-bottom: 10px;">Data Buku</h3>
    <table class="info-table">
        <tr>
    ...
    <h3 style="color: #24a148; margin-bottom: 10px;">Detail Pengembalian</h3>
    <table class="info-table">
        <tr>
        ...
        <tr>
            <td class="label">Tanggal Kembali Aktual</td>
            <td>: {{ $peminjaman->tanggal_pengembalian_aktual ? date('d/m/Y', strtotime($peminjaman->tanggal_pengembalian_aktual)) : 'Belum dikembalikan' }}
            </td>
        </tr>
        <tr>
            ...
            <td>:
                ...
                @else
                    <span class="status-badge status-pending">{{ $peminjaman->status_peminjaman }}</span>
                @endif
            </td>
        </tr>
        <tr>
            ...
            <td>:
                @if ($peminjaman->denda > 0)
                    <span class="denda-highlight">Rp {{ number_format($peminjaman->denda, 0, ',', '.') }}</span>
                @else
                    Rp 0
                @endif
            </td>
