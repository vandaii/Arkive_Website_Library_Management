<x-layouts.admin-dashboard>
    ...
    <div class="bg-white px-10 py-8 rounded-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="group border border-black/10 rounded-xl p-5 hover:shadow-lg transition-all duration-300 cursor-pointer relative"
                onclick="openPengajuanKembaliDetail({{ $pengajuan->id }})">
                <div class="absolute top-4 right-4">
                    <span class="badge badge-pending-kembali">
                        <i class="size-3 mr-1" data-lucide="clock"></i>{{ $pengajuan->status_peminjaman }}
                    </span>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <h3 class="font-semibold text-base line-clamp-1 transition-colors">
    ...
    <x-detail-modal id="pengajuanKembaliModal" title="Detail Pengajuan Pengembalian">
        <div class="flex gap-5 mb-5">
            ...
            <div class="flex-1">
                ...
                <span class="badge badge-pending-kembali"><i class="size-3 mr-1" data-lucide="clock"></i>{{ $pengajuan->status_peminjaman ?? null}}</span>
            </div>
        </div>
        ...
        <div class="border border-black/10 rounded-xl p-4">
            ...
            <div class="grid grid-cols-2 gap-x-6">
                ...
                <div class="modal-info-row">
                    ...
                    <span class="modal-info-value" id="pengajuanKembaliInfoPhone">-</span>
                </div>
                <div class="modal-info-row">
    ...
    <script>
        ...
        function openPengajuanKembaliDetail(id) {
            ...
            document.getElementById('pengajuanKembaliInfoPhone').textContent = p.user ? p.user.phone_number : '-';
